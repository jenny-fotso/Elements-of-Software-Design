...
#  Description: Adding functions to the graph class and testing them
...
#  Date Created: thursday april 29th

#  Date Last Modified: friday april 30th
...
class Graph (object):
  ...
  def get_neighbors (self, vertexLabel):
    ...
    for i in range( len(self.Vertices[idx]) ):
...
def main():
  ...
  for i in range(num_vertices):
    ...
    print(cities.adjMat[i][num_vertices-1])
  print()
